 ...
 */
function AmazonMwsClient(accessKeyId, secretAccessKey, merchantId, mwsAuthToken, options) {
  ...
  this.mwsAuthToken = mwsAuthToken || null;
...
AmazonMwsClient.prototype.call = function(api, action, query, callback) {
  if (this.secretAccessKey == null || this.accessKeyId == null || this.merchantId == null) {
  	console.log("accessKeyId, secretAccessKey, and merchantId must be set");
  ...
  if (this.mwsAuthToken) {
  	query["MWSAuthToken"] = this.mwsAuthToken;
  }
